...
public class Collection_12_clone {
	...
	public static void main(String[] args) {
		...
		Iterator it=list1.iterator();//to traverse an element one time
		while(it.hasNext())//boolean hasNext() returns true if iteration doesnt ends
		{//ie it has more elements
